...
def build_seq2seq(encoder_inputs_tensor,
        ...
        single_cell1 = tf.contrib.rnn.BasicLSTMCell(
        ...
        if attn_num_layers > 1:
            cell2 = tf.contrib.rnn.MultiRNNCell(
                [single_cell2] * attn_num_layers, state_is_tuple=False
            )
        ...
        def seq2seq_f(lstm_inputs, decoder_inputs, do_decode):
            ...
            top_states = [tf.reshape(e, [-1, 1, 512])
            ...
            outputs, _, attention_weights_history = embedding_attention_decoder(
                decoder_inputs, initial_state, attention_states, cell1, cell2,
