...
def parse_args():
    ...
    parser.add_argument('--attn_num_hidden',type=int,default=256,help='rnn unit size')
    parser.add_argument('--att_loss', action='store_true',default=False,help='att loss')
    ...
    parser.add_argument('--load_dir',type=str,default='./model/',help='pretrained weight path')
